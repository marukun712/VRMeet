...
export default function RoomMenu(props: Props) {
    ...
    return (
        <div className="flex w-screen">
            <div className={isShowMenu ? "absolute top-5 left-5" : "hidden"} ref={menuRef}>
                <Modal id="shere">
                ...
                <Modal id="settings">
                    ...
                    <button className="btn btn-success" onClick={() => props.scene.background = new THREE.Color("#5AFF19")}>GB</button>
                    <button className="btn bg-blue-500" onClick={() => props.scene.background = new THREE.Color("#0067C0")}>BB</button>
                    <button className="btn bg-red-500" onClick={() => props.scene.background = new THREE.Color("#FF0000")}>RB</button>
                ...
                <button className="bg-blue-300 btn" onClick={() => document.getElementById("shere").showModal()}>
                ...
                <button className="bg-blue-300 btn" onClick={() => document.getElementById("settings").showModal()}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <button className="bg-red-500 btn" onClick={() => { props.me.leave(); router.push("/") }}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <label className="swap absolute top-5 right-5">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 swap-off fill-current">
